...
class GPT(nn.Module):
    ...
    # The rest of the GPT class methods remain the same as before...
    # (e.g., crop_block_size, from_pretrained, configure_optimizers, estimate_mfu, generate)

    # For brevity, I will not repeat the methods that haven't changed.
